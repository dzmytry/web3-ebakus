      ...
      ;(function(I) {
        ...
        D
          ? ((n = I + '/'),
            ...
            process.on('unhandledRejection', tA),
            (Q.quit = function(A) {
              process.exit(A)
            }),
            (Q.inspect = function() {
          ...
          function D(A, g, D) {
            ...
            function n(A) {
              ;(Q.wasmBinary || (!o && !h) || 'function' != typeof fetch
                ...
                .then(A, function(A) {
                  c('failed to asynchronously prepare wasm: ' + A), tA(A)
                })
            }
            return (
              Q.wasmBinary ||
        ...
        var iA = (function(A, I, g, C) {
          ...
          var E
          if (
            ((E = ['function' == typeof nA ? nA : N, FA, N, t][2](
              Math.max(Q, 1)
            )),
            B)
          ) {
        ...
        if (
          ...
          (IA = function A() {
            Q.calledRun || NA(), Q.calledRun || (IA = A)
          }),
          (Q.run = NA),
          (Q.abort = tA),
          Q.preInit)
          ...
          function i(A) {
            ...
            try {
              ...
              var o = B.a.encode([
                ...
                h = H.a.keccak256(o),
                D = a.a.makeSigner(2 * t.a.toNumber(i.chainId || '0x1') + 35)(
                  H.a.keccak256(o),
                  I
                ),
                w = B.a
            ...
            methods: [
              {
                ...
                outputFormatter: A.utils.toDecimal,
              },
            ],
          })
