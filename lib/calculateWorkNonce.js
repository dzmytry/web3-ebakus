      ...
      f = e => t => {
        ...
        if ('0x' === t.slice(0, 2)) {
          ...
          for (var f = 2, s = t.length; f < s; f += 2)
            c.push(parseInt(t.slice(f, f + 2), 16))
        } else c = t
        return ((e, t) => {
          for (
            var c,
            ...
            if ('string' != typeof t)
              ...
              for (y = e.start; d < f && y < i; ++d)
                (c = t.charCodeAt(d)) < 128
                  ? (s[y >> 2] |= c << o[3 & y++])
                  : c < 2048
                  ? ((s[y >> 2] |= (192 | (c >> 6)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | (63 & c)) << o[3 & y++]))
                  : c < 55296 || c >= 57344
                  ? ((s[y >> 2] |= (224 | (c >> 12)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | ((c >> 6) & 63)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | (63 & c)) << o[3 & y++]))
                  : ((c =
                      65536 +
                      (((1023 & c) << 10) | (1023 & t.charCodeAt(++d)))),
                    (s[y >> 2] |= (240 | (c >> 18)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | ((c >> 12) & 63)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | ((c >> 6) & 63)) << o[3 & y++]),
                    (s[y >> 2] |= (128 | (63 & c)) << o[3 & y++]))
    ...
    s.parentPort.on('message', function(e) {
      !(function(e, t) {
        var r = 0,
          n = Math.log2(t),
          o = (n = Math.ceil(n)),
          c = new ArrayBuffer(2 * e.length),
          u = new Uint8Array(c, 64, 64),
          l = new Uint8Array(new Buffer(Object(f.keccak256)(e).slice(2), 'hex'))
        u.set(l)
        var p = new DataView(c, u.byteOffset, u.byteLength),
          d = 0
        do {
          p.setUint32(60, r)
          var b = new Uint8Array(
            ...
            k = a()(b)
          if (
            (console.log(r, Object(f.keccak256)(u)),
            k > d && ((d = k), console.log(r, d, o), d >= o))
          ) {
